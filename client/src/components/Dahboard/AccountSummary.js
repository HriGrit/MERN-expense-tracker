...
const AccountSummary = ({ accounts }) => {
	var more_fun = {},
		...
		expense = 0,
		income = 0;
	const fun = accounts?.map((acc) => {
		const transactions = acc?.transactions;
		balance += acc.initialBalance;
		more_fun = transactions?.map((transaction) => {
	...
	console.log(balance, expense, income);
	return (
		<>
			<div className="max-w-4xl mx-auto mb-12 text-center">
				<h3 className="mt-12 mb-4 text-3xl md:text-4xl leading-tight text-coolGray-900 font-bold tracking-tighter">
					...
					<div className="flex flex-wrap -m-3">
						...
						<div className="w-full md:w-1/3 p-3">
							<div className="p-8 bg-white border border-coolGray-100 rounded-md shadow-dashboard">
								<div className="flex flex-wrap items-end justify-between -m-2 mb-2">
									<div className="w-auto p-2">
										<h3 className="text-sm text-coolGray-500 text-green-400 font-medium">
											Income
										</h3>
									</div>
									<div className="w-auto p-2">
								...
								<div className="flex flex-wrap items-center justify-between -m-1">
									<div className="w-auto p-1">
										<h2 className="font-medium text-3xl text-green-500 tracking-tighter">
											$ {income}
										</h2>
									</div>
									<div className="w-auto p-1">
						...
						<div className="w-full md:w-1/3 p-3">
							<div className="p-8 bg-white border border-coolGray-100 rounded-md shadow-dashboard">
								<div className="flex flex-wrap items-end justify-between -m-2 mb-2">
									<div className="w-auto p-2">
										<h3 className="text-sm text-coolGray-500 text-red-400 font-medium">
											Expense
										</h3>
									</div>
									<div className="w-auto p-2">
								...
								<div className="flex flex-wrap items-center justify-between -m-1">
									<div className="w-auto p-1">
										<h2 className="font-medium text-3xl text-red-500 tracking-tighter">
											$ {expense}
										</h2>
									</div>
									<div className="w-auto p-1">
										<div className="flex items-center px-2 py-1 text-red-500 font-medium text-xs bg-red-100 rounded-full shadow-sm">
											{/* <svg
												width={12}
												height={12}
												viewBox="0 0 12 12"
